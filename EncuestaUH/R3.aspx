...
<body>
    <form id="form1" runat="server">
        <div class="auto-style1">
            <span class="auto-style2"><strong><em>PREGUNTA 3:</em></strong></span><br />
            <br />
            <asp:Image ID="Image1" runat="server" Height="355px" ImageUrl="~/imagenes/Captura de pantalla 2022-11-09 194433.png" Width="416px" />
            <br />
            <br />
